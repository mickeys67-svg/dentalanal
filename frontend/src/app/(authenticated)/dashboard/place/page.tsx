    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-foreground">{UI_TEXT.RANKING.TITLE}</h1>
            ...
            <div className="bg-card p-6 rounded-xl border shadow-sm">
                <label className="text-sm font-medium text-foreground mb-2 block">{UI_TEXT.RANKING.SEARCH_LABEL}</label>
