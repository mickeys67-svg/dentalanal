...
export function ControlPanel({
    ...
    return (
        <div className="bg-card/80 backdrop-blur-md p-6 rounded-3xl shadow-sm border border-border mb-8 flex flex-col md:flex-row items-center justify-between gap-6 transition-all">
            <div className="flex items-center gap-5">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground font-medium">현재 활성화된 분석 프로젝트</p>
                </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
                <button
                    ...
                    className="h-12 px-6 bg-card border border-border text-foreground rounded-xl font-bold hover:bg-secondary transition-all flex items-center gap-2 disabled:opacity-50"
                >
