                ...
                <div className="bg-card p-6 rounded-2xl shadow-sm border">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                        <div className="p-4 bg-blue-50 rounded-xl">
                            <p className="text-sm text-muted-foreground mb-1">총 검색 결과</p>
                            <p className="text-2xl font-bold text-blue-700">{sovData.total}개</p>
                        </div>
                        <div className="p-4 bg-blue-50 rounded-xl">
                            <p className="text-sm text-muted-foreground mb-1">내 브랜드 노출</p>
                            <p className="text-2xl font-bold text-blue-700">{sovData.hits}개</p>
                        </div>
                        <div className="p-4 bg-blue-50 rounded-xl">
                            <p className="text-sm text-muted-foreground mb-1">SOV 점유율</p>
                            <p className="text-3xl font-bold text-primary">{sovData.sov.toFixed(1)}%</p>
                        </div>
                    </div>
                </div>
            )}
