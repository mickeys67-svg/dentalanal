    ...
    return (
        <div
            className={cn(
                ...
                "rounded-xl border border-dashed border-border bg-background/60",
        ...
        >
            <div
                className={cn(
                    "rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-1",
            ...
            <p className={cn("text-muted-foreground leading-relaxed max-w-xs", compact ? "text-xs" : "text-sm")}>
                {body}
            </p>
