...
export const UI_TEXT = {
    RANKING: {
        TITLE: '키워드 순위 추적',
        SUBTITLE: '네이버 검색 상위 노출 순위와 경쟁 현황을 실시간으로 분석합니다.',
        SEARCH_LABEL: '분석할 키워드',
        SEARCH_PLACEHOLDER: '예: 다이어트, 제주도여행, 캠핑용품',
        BUTTON_SEARCH: '조사',
        BUTTON_LOADING: '조사 중...',
        INFO_TITLE: 'Info',
    ...
    SUMMARY: {
        ...
        DESC_COMPETITOR: '1위 브랜드',
        LOADING: '분석 중...',
    },
    TABLE: {
        TITLE_SUFFIX: '검색 결과',
        SUBTITLE: '실시간 네이버 검색 노출 순위',
        UPDATE_TIME: '업데이트',
        HEADER_RANK: '순위',
    ...
    VIRAL: {
        ...
        SEARCH_PLACEHOLDER: '예: 화장품 추천 후기',
        FEED_TITLE: '최신 언급 피드',
